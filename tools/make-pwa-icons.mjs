 ...
 * `admin/src`):
 *
 * - `admin/src/time-tracker.png` (512x512, 8 bit RGBA, not interlaced) for the two icons. PNG is read and
 *   written by hand (zlib and CRC32 from Node), which keeps the repository free of image libraries.
 * - `admin/src/time-tracker.svg` (a tracing of the logo) for the favicon: the drawing is vector, so a tab
...
function writeFavicon() {
	...
	const svg = [
		"<!-- Generated by tools/make-pwa-icons.mjs from admin/src/time-tracker.svg, do not edit. -->",
